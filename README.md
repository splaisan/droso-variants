...
A second file **[reference_data.txt](reference_data.txt)** will guide through getting and deploying teh genome reference data for this project (URLs and fiel names are as found at the time of writing this document and may change)
...
The code wxas ran on a rather strong server but should also execute on a lighter unix system (may take longer though!)
